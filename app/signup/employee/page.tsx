    ...
    return (
        <div className="sticky top-0 bg-[var(--background)] w-full flex flex-col items-center justify-center gap-12">
            ...
            <div className="max-w-[1280px] w-full flex flex-col items-center sm:gap-12 gap-8 p-3">
                ...
                <div className="w-full flex flex-row items-center justify-center mx-3 sm:p-12 p-6 sm:m-0 md:m-0 m-3 border rounded-lg">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-3 sm:pl-12 sm:border-l">
                        ...
                        <div className="w-full flex items-center justify-center flex-col sm:gap-3 gap-1">   
                            ...
                            <span className="font-sans font-semibold text-[color:var(--primary)] text-3xl">Employee Sign Up</span> 
                        </div> 

                        <span className="font-sans text-md text-gray-400 text-center">Join your company and get started.</span>
                        ...
                        <form onSubmit={handleSignUp} action="" className="w-full flex flex-col items-center justify-center gap-3 pt-12">
                            ...
                            <div className="sm:w-[360px] w-full flex flex-col items-start justify-center gap-2">
                                <span className="font-sans text-md text-gray-400">Full Name</span>
                                <input value={fullName} type="text" placeholder="Your full name" name="" id="" required 
                            ...
                            <div className="sm:w-[360px] w-full flex flex-col items-start justify-center gap-2">
                                ...
                                <input value={workEmail} type="email" placeholder="you@example.com" name="" id="" required 
                                    className="w-full px-3 py-2 border focus:border-[var(--primary)] rounded-lg outline-none"
                                    onChange={(e) => setWorkEmail(e.target.value)}/>
                            </div>

                            <div className="sm:w-[360px] w-full flex flex-col items-start justify-center gap-2">
                                <span className="font-sans text-md text-gray-400">Company Code / Invite Code</span>
                                <input value={companyCode} type="text" placeholder="Enter code" name="" id="" required 
                                    className="w-full px-3 py-2 border focus:border-[var(--primary)] rounded-lg outline-none"
                            ...
                            <div className="mt-12">
                                <span className="font-sans sm:text-md text-sm text-gray-400 text-center">Already have an employee account? </span>
                                <Link href="/login/employee" className="font-sans sm:text-md text-sm text-[var(--primary)] text-center cursor-pointer ml-1">Sign in</Link>
                            </div>
